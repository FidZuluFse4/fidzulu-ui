// Committed environment file (non-secret). Edit these values for local development.
export const environment = {
  ...
  bikeUrl:
    'https://2qd2ztcplupypes5da26zkhio40fpdtj.lambda-url.ap-southeast-2.on.aws/essentials/bikes',
};
